...
class HandReaderRight:
    ...
    def get_positions(self):
        ...
        for i, m in enumerate(self.state.motor_state):
            pos[f"mano_der_{i}"] = m.q   # 🔥 CAMBIO CLAVE
...
def capturar_hand_pose(hand):
    ...
    input("Posicione SOLO la mano derecha y presione Enter...")
...
def main():
    ...
    while True:
        ...
        print("2 → Capturar solo mano derecha")
